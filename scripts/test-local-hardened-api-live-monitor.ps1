...
try {
  ...
  Write-AuditLines $auditSameTurnMultiGateway @(
    ...
    [ordered]@{ schemaVersion = 1; timestamp = 3; requestId = "turn:sha256:same"; phase = "lease_granted"; route = "/v1/responses"; model = "gpt-5.5"; accountHash = "sha256:exhausted"; outcome = "active"; detail = [ordered]@{ gateway_request_id = "gw-same-open"; turn_lineage_id = "turn:sha256:same" } },
    [ordered]@{ schemaVersion = 1; timestamp = 4; requestId = "turn:sha256:same"; phase = "stream_write"; route = "/v1/responses"; model = "gpt-5.5"; accountHash = "sha256:exhausted"; status = 200; streamState = "first_chunk_written"; outcome = "ok"; detail = [ordered]@{ gateway_request_id = "gw-same-open"; turn_lineage_id = "turn:sha256:same" } },
    [ordered]@{ schemaVersion = 1; timestamp = 5; requestId = "turn:sha256:same"; phase = "listener"; route = "/v1/responses"; model = "gpt-5.5"; accountHash = "-"; outcome = "accepted"; detail = [ordered]@{ gateway_request_id = "gw-same-quota"; turn_lineage_id = "turn:sha256:same"; turn_lineage_source = "codex_turn_state" } },
    [ordered]@{ schemaVersion = 1; timestamp = 6; requestId = "turn:sha256:same"; phase = "request_trace"; route = "/v1/responses"; model = "gpt-5.5"; accountHash = "-"; outcome = "prepared"; detail = [ordered]@{ gateway_request_id = "gw-same-quota"; turn_lineage_id = "turn:sha256:same"; hard_affinity_continuity = "true"; sticky_boundary = "x_codex_turn_state" } },
    [ordered]@{ schemaVersion = 1; timestamp = 7; requestId = "turn:sha256:same"; phase = "upstream_forward"; route = "/v1/responses"; model = "gpt-5.5"; accountHash = "sha256:exhausted"; status = 429; outcome = "response_received"; detail = [ordered]@{ gateway_request_id = "gw-same-quota"; turn_lineage_id = "turn:sha256:same"; retry_after_ms = "3600000" } },
    [ordered]@{ schemaVersion = 1; timestamp = 8; requestId = "turn:sha256:same"; phase = "quota_classification"; route = "/v1/responses"; model = "gpt-5.5"; accountHash = "sha256:exhausted"; status = 429; errorType = "usage_limit_reached"; outcome = "exhausted"; detail = [ordered]@{ gateway_request_id = "gw-same-quota"; turn_lineage_id = "turn:sha256:same"; provider_code = "usage_limit_reached" } },
